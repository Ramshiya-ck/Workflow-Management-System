...
/**
 * Reusable layout block presenting detailed meta blocks in bill details.
 */
const BillInfoCard = ({ title, icon: Icon, children }) => {
  return (
...
export default React.memo(BillInfoCard);
