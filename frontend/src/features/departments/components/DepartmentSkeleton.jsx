...
/**
 * Pre-render skeleton boxes showing loader cards and rows layout.
 */
const DepartmentSkeleton = ({ view = "table" }) => {
  if (view === "grid") {
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="bg-white rounded-xl border border-zinc-200/80 p-5 space-y-4 shadow-[0_8px_30px_rgb(0,0,0,0.015)]">
...
export default React.memo(DepartmentSkeleton);
